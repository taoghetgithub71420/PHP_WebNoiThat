...
<body>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="../admin/index4.php" class="nav-link">Trang Chủ</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
  ...
  <!-- Main Sidebar Container -->
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="../page/index.php" class="brand-link">
        <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">KT Home</span>
      </a>
...
<!--                <a href="#" class="d-block">--><?php //echo $_SESSION["email"];?><!--</a>-->
                <a href="../admin/infoadmin.php?idAdmin=<?php echo $name["MaNhanVien"]?>" class="d-block"><?php echo $name["Hoten"];?></a>
            </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-close">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../admin/listBestSeller.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Best Seller</p>
                  </a>
                </li>
                ...
                ?>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="../admin/listStorage.php" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Nhập kho</p>
                            </a>
                        </li>
                ...
                <?php } else{ ?>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="../admin/404.php" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Nhập kho</p>
                            </a>
                        </li>
          ...
          <li class="nav-item menu-close">
              ...
              <li class="nav-item menu-close">
                  ...
                  <ul class="nav nav-treeview">
                      <li class="nav-item">
                          <a href="../admin/listShip.php" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Quản lí phí ship</p>
                          </a>
                      </li>
                  </ul>
              </li>
              ...
              <li class="nav-item">
                  <a href="<?php echo $_SERVER["PHP_SELF"];?>?dxadmin=0?>" class="nav-link">
