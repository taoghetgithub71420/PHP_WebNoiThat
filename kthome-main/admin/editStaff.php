...
<?php
    if(!isset($_GET["Mastaff"]))
        echo "<script>location='listStaff.php'</script>";
    $getStaff= "SELECT * FROM nhanvien WHERE MaNhanVien = '".$_GET["Mastaff"]."'";
    $query = mysqli_query($conn,$getStaff);
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        $role = $_POST["role"];
        $status_staff = $_POST["idstatus"];
        $date = $_POST["date"];
        $phone =$_POST["phone"];
        $email = $dbdata["TenDangNhap"];
        $pass = $dbdata["MatKhau"];

        $sql = "UPDATE nhanvien SET Hoten = '".$name."',TenDangNhap = '".$email."',MatKhau = '".$pass."',Ngaysinh = '".$date."',DienThoai = '".$phone."', MaRole = '".$role."', MaTrangThaiNhanVien = '".$status_staff."' WHERE MaNhanVien = '".$_GET["Mastaff"]."'";
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <h1 class="m-0">Thông tin tài khoản, <?php echo $dbdata["Hoten"]?> </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                </div><!-- /.col -->
            </div><!-- /.row -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control col-md-8" name="namestaff" value="<?php echo empty($_POST["namestaff"])? $dbdata["Hoten"] : $_POST["namestaff"]?>" placeholder="Tên sản phẩm">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Trạng thái nhân viên</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control col-md-8" name="email" value="<?php echo empty($_POST["email"])? $dbdata["Email"] : $_POST["email"]?>" placeholder="Email" disabled>
                                </div>
                                <div class="form-group">
