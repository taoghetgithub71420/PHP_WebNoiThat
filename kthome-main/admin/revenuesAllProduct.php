        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <h1 class="m-0">Lợi nhuận theo tất cả sản phẩm</h1>
                </div><!-- /.col -->
                    ...
                    <table class="table">
                        ...
                        <?php
                            $sort = "SELECT *, SUM(ct_dondat.Soluong) as total 
                                ...
                                WHERE dondat.TrangThai = 'Hoàn thành'
...
//                                $kho1 = mysqli_fetch_row($query_kho1);
                                ...
                                $total_income1 += ($row["GiaSanPham"]*$row["total"]) - ($row["GiaVon"]* $row["total"]);
                            ?>
                            <tr>
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="position: fixed;bottom: 0;left: 0;right: 0;z-index: 1">
    ...
    <ul class="navbar-nav">
        <li class="nav-item d-none d-sm-inline-block">
            <h5 class="nav-link" style="margin-left: 20px;font-weight: bold"">Tổng tiền:</h5>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="#" class="nav-link" style="margin-left: 390px;font-weight: bold"><?php echo $total_count1?></a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="#" class="nav-link" style="margin-left: 265px;font-weight: bold"><?php echo number_format($total_revenues1,0,",",".")?></a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="#" class="nav-link" style="margin-left: 180px;font-weight: bold"><?php echo number_format($total_kho1,0,",",".")?></a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
